...
#    under the License.
#
#Unit Tests for OVSvAPP-l2-Agent RPC
...
class OVSvAppServerRpcCallbackTest(test_rpcapi.RpcCallbacksTestCase):
    ...
    def setUp(self):
        ...
        self.ovsvapp_callbacks = ovsvapp_rpc.OVSvAppServerRpcCallback(mock.Mock())
    ...
    def test_get_ports_for_device(self):
        ...
        with contextlib.nested(
            ...
            mock.patch.object(self.ovsvapp_callbacks.notifier, 'device_create'),
...
class OVSvAppAgentNotifyAPITest(test_rpcapi.RpcApiTestCase):
    ...
    def test_get_ports_for_device(self):
        rpcapi = ovsvapp_agent.OVSvAppPluginApi(OVSVAPP)
    ...
    def test_device_create(self):
        ...
        self._test_rpc_api(rpcapi,
                           topics.get_topic_name(topics.AGENT,
                                                 ovsvapp_rpc.DEVICE,
                                                 topics.CREATE),
                           'device_create', rpc_method='fanout_cast',
                           device='fake_device',
                           ports='fake_ports',
    ...
    def test_device_update(self):
        ...
        self._test_rpc_api(rpcapi,
                           topics.get_topic_name(topics.AGENT,
                                                 ovsvapp_rpc.DEVICE,
                                                 topics.UPDATE),
                           'device_update', rpc_method='fanout_cast',
